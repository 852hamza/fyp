            ...
            <div class="carousel-item testimonial-item">
                <div class="card testimonial-card">
                    ...
                    <div class="card-content">
                        ...
                        <p>
                            Expert in cloud computing with over 3 years of experience in large scale infrastructure management & Specializes in web development and database systems.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item testimonial-item">
                <div class="card testimonial-card">
                    ...
                    <div class="card-content">
                        ...
                        <p>
                            Specializes in Ui/UX,passionate about new web technologies.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="carousel-item testimonial-item">
                <div class="card testimonial-card">
                    ...
                    <div class="card-content">
                        ...
                        <p>
                            Front-end developer with a keen eye for design and user experience, expert in React and JavaScript and class.
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var elems = document.querySelectorAll('.carousel.testimonials, .carousel.carousel-slider');
