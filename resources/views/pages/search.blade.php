        ...
        <div class="row">
            ...
            <div class="col s12 m4 card">
                ...
                <div class="input-field col s12">
                    <button type="button" class="btn red clear-btn" onclick="resetForm()">Clear</button>
                </div>
...
<script>
    function resetForm() {
        // This function will reset all form elements to their default values
        document.querySelector('.sidebar-search').reset();
    }
</script>
